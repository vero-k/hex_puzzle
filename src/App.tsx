  ...
  return (
    <GameProvider>
      ...
      <Routes>
        ...
        <Route path="/loading-p3" element={<LoadingP3 />} />
        <Route path="/loading-p2" element={<LoadingP2 />} />
        <Route path="/loading-p15" element={<LoadingP15 />} />
        <Route path="/loading-p1" element={<LoadingP1 />} />
